package com.jornada.demo_park_api;
...
public class AutenticacaoIT {
    ...
    @Test
    public void autenticar_ComCredenciaisValidas_RetonarTokenComStatus200(){
    ...
    @Test
    public void autenticar_ComCredenciaisInvalidas_RetonarErrorMessageStatus400(){
        ...
        responseBody =  testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("ana@gmail.com", "1233456"))
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void autenticar_ComUsernameInvalidas_RetonarErrorMessageStatus422(){
        ErrorMessage responseBody =  testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void autenticar_ComPasswordInvalidas_RetonarErrorMessageStatus422(){
        ErrorMessage responseBody =  testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
