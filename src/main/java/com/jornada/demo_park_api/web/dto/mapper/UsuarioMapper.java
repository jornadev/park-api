package com.jornada.demo_park_api.web.dto.mapper;
...
public class UsuarioMapper {
    ...
    public static UsuarioResponseDto toDto(Usuario usuario){
        String role = usuario.getRole().name().substring(0, 1).toUpperCase() + usuario.getRole().name().substring("ROLE_".length());
